...
class BACKGROUNDS(Set):  # todo: ADD EQUIPMENT FOR BACKGROUNDS, ADD SUPPORT FOR TOOLS
    class ACOLYTE:
        SKILL = {SKILL.INSIGHT, SKILL.RELIGION}

    class CHARLATAN:
        SKILL = {SKILL.DECEPTION, SKILL.SLEIGHT}

    class CRIMINAL:
        SKILL = {SKILL.DECEPTION, SKILL.STEALTH}

    class FOLK_HERO:
        SKILL = {SKILL.ANIMAL_HANDLING, SKILL.SURVIVAL}

    class GUILD_ARTISAN:
        SKILL = {SKILL.INSIGHT, SKILL.PERSUASION}

    class HERMIT:
        SKILL = {SKILL.MEDICINE, SKILL.RELIGION}

    class NOBLE:
        SKILL = {SKILL.HISTORY, SKILL.PERSUASION}

    class OUTLANDER:
        SKILL = {SKILL.ATHLETICS, SKILL.SURVIVAL}

    class PERFORMER:
        SKILL = {SKILL.ACROBATICS, SKILL.PERFORMANCE}

    class SAGE:
        SKILL = {SKILL.ARCANA, SKILL.HISTORY}

    class SAILOR:
        SKILL = {SKILL.ATHLETICS, SKILL.PERCEPTION}

    class SOLDIER:
        SKILL = {SKILL.ATHLETICS, SKILL.INTIMIDATION}

    class URCHIN:
        SKILL = {SKILL.SLEIGHT, SKILL.STEALTH}
